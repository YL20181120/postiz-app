      ...
      <div className="flex flex-col gap-[40px]">
        <div className="text-[14px] text-textColor leading-[1.7]">
          {t(
            ...
            'Create an OAuth App to let other Veloop users authorize your product to post on their behalf.'
          )}
          <br />
          {t(
            ...
            <div>
              ...
              <div className="text-[13px] text-customColor18 mt-[2px]">
                {t(
                  ...
                  'Create an OAuth application to allow third-party integrations with Veloop on behalf of your users.'
                )}
              </div>
            </div>
