        ...
        <div>
          ...
          <div className="text-[13px] text-customColor18 mt-[2px]">
            {t(
              ...
              'Connect Veloop MCP server to your client (Http streaming) to schedule your posts faster.'
            )}
          </div>
        </div>
...
const localCliSteps = [
  ...
  {
    label: 'Install the Veloop skill for your AI agent',
      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder flex items-start justify-between gap-[12px]">
        <div>
          ...
          <div className="text-[13px] text-customColor18 mt-[2px]">
            {t(
              'cli_description',
              'Use the Veloop CLI to automate posting from your terminal, or install the skill to let your AI agent schedule posts for you.'
            )}
          </div>
        </div>
        <div className="flex gap-[6px] shrink-0 pt-[2px]">
  ...
  return (
    <div className="flex flex-col gap-[40px]">
      <div className="text-[14px] text-textColor leading-[1.7]">
        ...
        {t(
          'api_auth_note_line2',
          'If you are building a product that schedules posts on behalf of other Veloop users,'
        )}
        <br />
        {t(
          'api_auth_note_line3',
          ...
          <div>
            ...
            <div className="text-[13px] text-customColor18 mt-[2px]">
              {t(
                ...
                'Use Veloop API to integrate with your tools.'
              )}
            </div>
          </div>
          <div className="flex gap-[6px] shrink-0 pt-[2px]">
