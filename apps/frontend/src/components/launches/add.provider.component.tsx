    ...
    <div className="flex flex-col gap-[16px] pt-[8px]">
      <p className="text-[14px] text-textColor/80">
        {t(
          ...
          'The Veloop browser extension is not installed. You need to install it before connecting this channel.'
        )}
      </p>
  ...
  return (
    <div className="flex flex-col gap-[16px] pt-[8px]">
      ...
      <ul className="flex flex-col gap-[8px] list-disc ps-[20px] text-[14px] text-textColor/80">
        ...
        <li>
          Veloop does not take responsibility for any issues arising or account
          ...
          try {
            ...
            toaster.show(
              t(
                ...
                'Veloop browser extension is not installed or not reachable.'
              ),
              'warning'
            );
            return;
