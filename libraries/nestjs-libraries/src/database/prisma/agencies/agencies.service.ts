  ...
  async approveOrDecline(email: string, action: string, id: string) {
    ...
    if (action === 'approve') {
      await this._notificationService.sendEmail(
        agency?.user?.email!,
        'Your Agency has been approved and added to Veloop 🚀',
        `
<html lang="en">
...
<head>
    ...
    <title>Your Agency has been approved and added to Veloop 🚀</title>
</head>

<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
  Hi there, <br /><br />
  Your agency ${agency?.name} has been added to Veloop!<br />
  You can <a href="https://postiz.com/agencies/${agency?.slug}">check it here</a><br />
  It will appear on the main agency of Veloop in the next 24 hours.<br /><br />
</body>
</html>`
      );
...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
  Hi there, <br /><br />
  Your agency ${agency?.name} has been declined to Veloop!<br />
