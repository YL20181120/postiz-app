export const testimonials1 = [
  ...
  },
  {
    ...
    content: (
      <>
        I just found out about Veloop, a tool for scheduling social media.{' '}
        {'\n'}
        ...
        {'\n'}
        Veloop seems to focus on just doing one thing well. {'\n'}
        {'\n'}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        As a privacy-first company we appreciate being able to self-host Veloop!
  ...
  },
  {
    ...
    content: (
      <>
        Veloop changed how we manage our social media presence by aggregating
        our platforms into one effective tool. Post scheduling, and AI post
        ideation are two of the many features that come with Veloop, and have
  ...
  },
  {
    ...
    content: (
      <>
        ...
        n8n + Veloop =🔥Never miss a day of posting again: {'\n\n'}→ Easy to get
  ...
  },
  {
    ...
    content: (
      <>
        Manage all your social media accounts from a single place: Veloop, a
...
export const testimonials2 = [
  {
    ...
    content: (
      <>
        🌟 Exciting news! 🚀 I've just started using Veloop, a fantastic new
        tool for scheduling my social media content! {'\n\n'}
        Why did I choose Veloop? The ability to self-host it means significant
        savings for me! 💰 {'\n\n'}
        Veloop is an open-source scheduling tool that allows you to plan and
        ...
        scheduling! 📅✨ {'\n\n'}
        Built with privacy and flexibility in mind, Veloop can run on your own
  ...
  },
  {
    ...
    content: (
      <>
        Veloop makes it so easy to plan ahead. The AI suggestions are relevant,
